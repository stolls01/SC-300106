...
| Task    | Name of script | Output most relevant for downstream |
| -------- | ------- | ---------|
...
| Trim data to remove low-quality/low-information reads |    trim.sh  | Quality report + 4 fastq files of dropped vs. retained fw and rv reads |
| Generate a count table as a proxy for expression levels |counts.sh    | results/map/SRR36696742_feature_count.tsv results/map/SRR36696742_filtered_trimmed_HldesRot8A_Aligned.sortedByCoord.out.bam (compressed bam and feature count)|
